...
class couleurController extends Controller
{
    ...
    //{
      public function menuAction()
      {
          ...
          $couleurs = $em->getRepository('EcommerceBundle:couleur')->findAll();

          return $this->render('EcommerceBundle:Default:couleur/modulesUsed/menu.html.twig', array('couleurs' => $couleurs));
      }
