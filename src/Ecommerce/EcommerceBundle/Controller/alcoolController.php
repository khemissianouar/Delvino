...
class alcoolController extends Controller
{
    ...
    //{
      public function menuAction()
      {
          ...
          $alcools = $em->getRepository('EcommerceBundle:alcool')->findAll();

          return $this->render('EcommerceBundle:Default:alcool/modulesUsed/menu.html.twig', array('alcools' => $alcools));
      }
