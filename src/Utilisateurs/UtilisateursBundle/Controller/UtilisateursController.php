...
class UtilisateursController extends Controller
{
    public function facturesAction()
    {
        ...
        $factures = $em->getRepository('EcommerceBundle:commande')->byFacture($this->getUser());
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $facture = $em->getRepository('EcommerceBundle:commande')->findOneBy(array('utilisateur' => $this->getUser(),
                                                                                     'valider' => 1,
                                                                                     'id' => $id));
